"""The main application definition for nublado2 service."""
...
from nublado2.config import Configuration
from nublado2.handlers import init_external_routes, init_internal_routes
...
def create_app() -> web.Application:
    ...
    setup_metadata(package_name="nublado2", app=root_app)
